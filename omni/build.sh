...
KITCHEN_REPOSITORY="${COMFY_KITCHEN_REPOSITORY:-https://github.com/shinosawabot/comfy-kitchen.git}"
KITCHEN_COMMIT="${COMFY_KITCHEN_COMMIT:-e4e8ef8c241ebb8a41106355ce73eb05a2e1ddca}"
KITCHEN_VERSION="${COMFY_KITCHEN_VERSION:-0.2.35}"
KITCHEN_PROVIDER_VERSION="${COMFY_KITCHEN_PROVIDER_VERSION:-0.2.33}"
